...
//     if (!decodedToken || !decodedToken.name || !decodedToken.email || !decodedToken.password) {
//       return res.status(400).send({ message: 'Invalid token or missing payload data' });
//     }
...
//         const newToken = signInToken(newUser);
...
// const loginCustomer = async (req, res) => {
//   try {
//     const customer = await Customer.findOne({ phone: req.body.registerPhone });
